...
**为什么不用固定的 252**：252 是美股的惯例值。A 股一年的交易日数不一样（近年在 242–245 之间，约 243），套用 252 会把每日波动算小约 2%。

以今天的上证50ETF 为例（2026 年按 243 个交易日计）：
...
| 沪深300ETF | 16.44 | 常态 | ±1.05% |
| 中证500ETF | 23.97 | 紧张 | ±1.54% |
| 创业板ETF | 29.10 | 紧张 | ±1.87% |
| 科创50ETF | 36.08 | 恐慌 | ±2.31% |
...
> **口径提醒**：252 是美股惯例值，A 股一年的交易日数约 243；而 VIX 的期限按**日历日**（365）折算。**两个年化基准不一致，会让 VRP 系统性偏小**（实测偏低 3–7 个点）。
